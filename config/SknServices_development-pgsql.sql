...
INSERT INTO users (id, username, name, email, password_digest, remember_token, password_reset_token, password_reset_date, assigned_groups, roles, active, file_access_token, created_at, updated_at, person_authentication_key, assigned_roles, remember_token_digest, user_options) VALUES (1, 'developer', 'Skoona Developer', 'skoona@gmail.com', '$2a$10$Nx5AeWbk77HXLHgJPp3FteKOZKhGwwSlESVk6HtWzW5DABjHXdlc2', 'ECLuMFBZCuiUVqILFuAtyQ', NULL, NULL, '---
- Developer
...
- ''0099''
');
INSERT INTO users (id, username, name, email, password_digest, remember_token, password_reset_token, password_reset_date, assigned_groups, roles, active, file_access_token, created_at, updated_at, person_authentication_key, assigned_roles, remember_token_digest, user_options) VALUES (2, 'emtester', 'Department Manager', 'emtester@localhost.com', '$2a$10$japIq0O3jrAwjirIBxhuxOy2zJmLDkz9bN1qO5MHc9Q6QyCvs3uXO', 'xVw2fVayFYgZvMdpUSkHAQ', NULL, NULL, '---
- Manager
...
- ''0099''
');
INSERT INTO users (id, username, name, email, password_digest, remember_token, password_reset_token, password_reset_date, assigned_groups, roles, active, file_access_token, created_at, updated_at, person_authentication_key, assigned_roles, remember_token_digest, user_options) VALUES (3, 'eptester', 'Employee Primary User', 'appdev@localhost.com', '$2a$10$A2nDx49QfVr1GkyXyzmldOA0GpZJYeFCPG.TjpPGl1QlPy8jKIPwy', '-ghvBu9fdMPm_326fa37vA', NULL, NULL, '---
- EmployeePrimary
...
- ''0099''
');
INSERT INTO users (id, username, name, email, password_digest, remember_token, password_reset_token, password_reset_date, assigned_groups, roles, active, file_access_token, created_at, updated_at, person_authentication_key, assigned_roles, remember_token_digest, user_options) VALUES (6, 'bstester', 'Branch Secondary User', 'appdev3@localhost.com', '$2a$10$Sg/gS63fixhrvaEwvhOpY./wNMO56ESi2V7PGQcJOdsr.NyaNeSge', 'XV5g-Mf7JEUoa5rJ0jJQ3g', NULL, NULL, '---
- BranchSecondary
...
INSERT INTO users (id, username, name, email, password_digest, remember_token, password_reset_token, password_reset_date, assigned_groups, roles, active, file_access_token, created_at, updated_at, person_authentication_key, assigned_roles, remember_token_digest, user_options) VALUES (8, 'vptester', 'Vendor Primary User', 'appdev4@localhost.com', '$2a$10$yrsSd1MmP.50JYNYR07DTOGQUmJNVEolj/FILIqg4fgBj/qPiABhO', 'kwuJWyZ8TxnAWnlWeaXC_w', NULL, NULL, '---
- VendorPrimary
...
-- Name: index_users_on_person_authentication_key; Type: INDEX; Schema: public; Owner: postgres; Tablespace:
--
